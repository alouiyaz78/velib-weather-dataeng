SELECT
    ...
    EXTRACT(MONTH FROM (duedate AT TIME ZONE 'Europe/Paris'))::SMALLINT AS month_of_year,
    ...
    cloud_cover,
    wind_speed_10m,
    ROUND(bikes_available::numeric / NULLIF(bikes_available + docks_available, 0) * 100, 2) AS occupancy_rate
