...
CREATE INDEX IF NOT EXISTS idx_velib_stations_duedate ON bronze.velib_stations USING BRIN (duedate);
CREATE INDEX IF NOT EXISTS idx_velib_stations_stationcode ON bronze.velib_stations (stationcode);
